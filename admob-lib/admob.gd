...
@export var ads_using_consent:bool :
	get:
...
@export var testing_consent:bool :
	get:
...
#		if not _admob_singleton.is_connected("on_admob_ad_loaded", self, "_on_admob_ad_loaded"):
		if not _admob_singleton.is_connected("on_admob_ad_loaded", _on_admob_ad_loaded):
			connect_signals()
...
func connect_signals() -> void:
	_admob_singleton.connect("on_admob_ad_loaded", _on_admob_ad_loaded)
	_admob_singleton.connect("on_admob_banner_failed_to_load", _on_admob_banner_failed_to_load)
	_admob_singleton.connect("on_interstitial_failed_to_load", _on_interstitial_failed_to_load)
	_admob_singleton.connect("on_interstitial_opened", _on_interstitial_opened)
	_admob_singleton.connect("on_interstitial_loaded", _on_interstitial_loaded)
	_admob_singleton.connect("on_interstitial_close", _on_interstitial_close)
	_admob_singleton.connect("on_interstitial_clicked", _on_interstitial_clicked)
	_admob_singleton.connect("on_interstitial_impression", _on_interstitial_impression)
	_admob_singleton.connect("on_rewarded_video_ad_loaded", _on_rewarded_video_ad_loaded)
	_admob_singleton.connect("on_rewarded_video_ad_opened", _on_rewarded_video_ad_opened)
	_admob_singleton.connect("on_rewarded_video_ad_closed", _on_rewarded_video_ad_closed)
	_admob_singleton.connect("on_rewarded_video_ad_failed_to_load", _on_rewarded_video_ad_failed_to_load)
	_admob_singleton.connect("on_rewarded_interstitial_ad_loaded", _on_rewarded_interstitial_ad_loaded)
	_admob_singleton.connect("on_rewarded_interstitial_ad_opened", _on_rewarded_interstitial_ad_opened)
	_admob_singleton.connect("on_rewarded_interstitial_ad_closed", _on_rewarded_interstitial_ad_closed)
	_admob_singleton.connect("on_rewarded_interstitial_ad_failed_to_load", _on_rewarded_interstitial_ad_failed_to_load)
	_admob_singleton.connect("on_rewarded_interstitial_ad_failed_to_show", _on_rewarded_interstitial_ad_failed_to_show)
	_admob_singleton.connect("on_rewarded", _on_rewarded)
	_admob_singleton.connect("on_rewarded_clicked", _on_rewarded_clicked)
	_admob_singleton.connect("on_rewarded_impression", _on_rewarded_impression)

	_admob_singleton.connect("on_consent_info_update_success", _on_consent_info_update_success)
	_admob_singleton.connect("on_consent_info_update_failure", _on_consent_info_update_failure)
	_admob_singleton.connect("on_app_can_request_ads", _on_app_can_request_ads)
